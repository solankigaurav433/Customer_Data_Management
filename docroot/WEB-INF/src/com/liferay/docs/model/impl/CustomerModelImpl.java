...
import com.liferay.docs.model.CustomerModel;
import com.liferay.docs.model.CustomerSoap;
...
/**
 * The base model implementation for the Customer service. Represents a row in the &quot;AA_Customer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.docs.model.CustomerModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CustomerImpl}.
 * </p>
 *
 * @author ADMIN
 * @see CustomerImpl
 * @see com.liferay.docs.model.Customer
 * @see com.liferay.docs.model.CustomerModel
 * @generated
 */
@JSON(strict = true)
public class CustomerModelImpl extends BaseModelImpl<Customer>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a customer model instance should use the {@link com.liferay.docs.model.Customer} interface instead.
	 */
	public static final String TABLE_NAME = "AA_Customer";
	...
	public static final String TABLE_SQL_CREATE = "create table AA_Customer (uuid_ VARCHAR(75) null,customerId LONG not null primary key,name VARCHAR(75) null,email VARCHAR(75) null,address VARCHAR(75) null,phone VARCHAR(75) null,passportNo VARCHAR(75) null,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,serviceId LONG)";
	public static final String TABLE_SQL_DROP = "drop table AA_Customer";
	public static final String ORDER_BY_JPQL = " ORDER BY customer.customerId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY AA_Customer.customerId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.docs.model.Customer"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.docs.model.Customer"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.docs.model.Customer"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.docs.model.Customer"));
	...
	public Object clone() {
		...
		customerImpl.setPassportNo(getPassportNo());
	...
	public CacheModel<Customer> toCacheModel() {
		...
		customerCacheModel.passportNo = getPassportNo();

		String passportNo = customerCacheModel.passportNo;

		if ((passportNo != null) && (passportNo.length() == 0)) {
			customerCacheModel.passportNo = null;
		}
